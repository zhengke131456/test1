<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartSelectRight.aspx.cs"
    Inherits="product.user.PartSelectRight" %>
...
<body >
    ...
    <script>
        ...
        function ReturnValue() {
            ...
            if (confirm("确认修改权限！")) {
                $.post("../Handler/addFunctionalnodes.ashx?note=" + treenote, { id: $('#hidtype').val() }, function (data) {
                    if (data == "1") {
