<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartSelectCityArea.aspx.cs"
    Inherits="product.user.PartSelectCityArea" %>
    ...
    <script>
        ...
        function ReturnValue() {
            ...
            if (confirm("确认修改权限！")) {
                ...
                $.post("../Handler/addCityNodes.ashx?note=" + treenote, { id: $('#hidtype').val() }, function (data) {
                    if (data == "1") {
