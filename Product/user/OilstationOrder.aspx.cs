...
{
    public partial class OilstationOrder : Common.BasePage
    {
        ...
        private void InitParam(string Index)
        {
            ...
            #region
            sinfo.Sqlstr = " (SELECT OrderPhone.id,UserID,(Dimension+ PATTERN) AS canshu,yuyuenum,OrderPhone.userName,usertel ";
  ...
  sinfo.Sqlstr+=" WHERE Utype=1 AND OrderPhone.citycode in("+ hiddpart.Value +"))hh ";
