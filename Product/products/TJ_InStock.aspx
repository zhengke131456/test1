<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TJ_InStock.aspx.cs" Inherits="product.products.TJ_InStock" %>
    ...
    <div id="right">
        ...
        <div class="page ">
            ...
            <div class="clear"></div>
             ...
             <form id="form1" style="display:inline-block; float:left;" method="post" action="TJ_InStock.aspx">
