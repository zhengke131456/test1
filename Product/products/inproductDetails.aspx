<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inproductDetails.aspx.cs" Inherits="product.products.inproductDetails" %>
    ...
    <div id="right">
        <div class="page ">
          <p class="left" id="addp" >
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a style="color: Red;" href="../products/inproductList.aspx">返回</a> &nbsp;
