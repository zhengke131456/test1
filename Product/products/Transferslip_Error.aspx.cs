...
{
    public partial class Transferslip_Error : Common.BasePage
    {
        ...
        private void bindData()
        {
            ...
            if (!ds.Equals(null))
            {
                ...
                else
                {
                    ...
                    literalPagination.Text = GenPaginationBar("Transferslip_Error.aspx?page=[page]&outwh=" + outwh + "&rpcode=" + rpcode + "&inwh=" + inwh + "", pagesize, curpage, allCount);
                }
            }
        }
        ...
        private void InitParam(string Index)
        {
            ...
            //待审核
            sinfo.Sqlstr += "  and (states  ='出库异常' or states  ='入库异常') ";
